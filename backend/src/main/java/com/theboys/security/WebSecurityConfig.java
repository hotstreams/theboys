    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/entrepreneurs/**").hasAnyRole(CUSTOMER.name(), MANAGER.name(), HERO.name())
                        ...
                        .requestMatchers("/candidates").hasAnyRole(MANAGER.name(), SCIENTIST.name(), VISITOR.name())
                        .requestMatchers("/medicines").hasRole(SCIENTIST.name())
                        .requestMatchers("/scientists/**").hasAnyRole(SCIENTIST.name(), MANAGER.name())
                        .requestMatchers("/managers/**").hasAnyRole(MANAGER.name(), VISITOR.name())
