...
drop table if exists s265062.vacancy cascade;
...
create table s265062.candidate_requests (first_name varchar(255), last_name varchar(255), birthday varchar(255) not null, candidate_order_id serial not null, height varchar(255) not null, status varchar(255) not null check (status in ('PENDING', 'IN_PROGRESS', 'FULFILLED')), scientist_id integer, weight varchar(255) not null, description varchar(255), race varchar(255), sex varchar(255), primary key (candidate_order_id));
...
create table s265062.hero_cultivation_orders (hero_cultivation_order_id serial not null, manager_id integer, status varchar(255), description text, primary key (hero_cultivation_order_id));
...
create table s265062.orders (customer_id integer not null, date date, start_date date, end_date date, request_description varchar(255), hero_id integer, order_id serial not null, hero_description varchar(255), status varchar(255) not null, primary key (order_id));
...
create table s265062.researches (candidate_id integer unique, doze_count integer not null, doze_ml integer not null, exam_passed boolean, medicine_id integer, research_id serial not null, scientist_id integer not null, result varchar(255), status varchar(255) not null, primary key (research_id));
...
create table s265062.vacancy (first_name varchar(255), last_name varchar(255), birthday varchar(255) not null, vacancy_id serial not null, height varchar(255) not null, status varchar(255) not null, weight varchar(255) not null, description varchar(255), race varchar(255), sex varchar(255), primary key (vacancy_id));
