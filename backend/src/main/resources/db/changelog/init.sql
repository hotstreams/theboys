...
create table s265062.candidate_requests (birthday date not null, candidate_order_id serial not null, height integer not null, status varchar(255) not null check (status in ('PENDING', 'IN_PROGRESS', 'FULFILLED')), scientist_id integer, weight integer not null, description varchar(255), race varchar(255), sex varchar(255), primary key (candidate_order_id));
