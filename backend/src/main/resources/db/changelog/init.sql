...
create table s265062.vacancy (first_name varchar(255), last_name varchar(255), birthday varchar(255) not null, vacancy_id serial not null, height varchar(255) not null, status varchar(255) not null check (status in ('CLOSED', 'OPEN', 'FOUND')), weight varchar(255) not null, description varchar(255), race varchar(255), sex varchar(255), primary key (vacancy_id));
