insert into s265062.users (id,login,password,role) values (1,'login','{bcrypt}$2a$10$gME7VLRHiw4dbjAJEJ9EM.1KA4/5jQwg6gQ6r9fCNJ2n3uPawF/OG', 'VISITOR')
...
insert into s265062.candidates values ('2000-03-04'::date, 8, 180, 75, 'SPB', 'Some candidate', 'John', 'Doe', '+19483728494', 'white', 'male', 'WAITING', null, null)
;
...
insert into s265062.customers values (28);
insert into s265062.orders values (500000, 28, '2023-08-08'::date, 7, 1, null, 'PENDING')
