...
drop schema if exists s265062;
create schema s265062;
...
create table s265062.posts (hero_id integer not null, post_id integer not null, description varchar(255), title varchar(255) not null, "at" timestamp with time zone not null, primary key (post_id));
