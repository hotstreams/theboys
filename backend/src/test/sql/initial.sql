...
create table theboys.user_hero_subscriptions (hero_id integer not null, user_id integer not null, primary key (hero_id, user_id));
create table theboys.user_hero_rates (hero_id integer not null, user_id integer not null, rate integer not null check (rate < 6 and rate > 0), primary key (hero_id, user_id));
