<script lang="ts">
    ...
    function validate() {
      ...
      if (!/^[0-9]{2}\-[0-9]{2}\-[0-9]{4}$/.test(dateStart) || !/^[0-9]{2}\-[0-9]{2}\-[0-9]{4}$/.test(dateEnd)) {
          validationError = true
          validationMesssage = 'Dates should be XX-XX-XXXX'
          return false
      }
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                              ...
                              <div date-rangepicker class="mt-10 flex items-center">
                                <div class="relative">
                                  ...
                                  <input bind:value={dateStart} name="start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Date start XX-XX-XXX">
                                </div>
                                ...
                                <div class="relative">
                                  ...
                                  <input bind:value={dateEnd} name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Date end XX-XX-XXXX">
                                </div>
                              </div> 
